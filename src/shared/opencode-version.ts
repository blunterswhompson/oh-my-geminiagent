...
/**
 * OpenCode version that introduced native GEMINI.md injection.
 * PR #10678 merged on Jan 26, 2026 - OpenCode now dynamically resolves
 * GEMINI.md files from subdirectories as the agent explores them.
 * When this version is detected, the directory-agents-injector hook
 * is auto-disabled to prevent duplicate GEMINI.md loading.
 */
