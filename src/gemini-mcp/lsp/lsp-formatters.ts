...
export function formatSymbol(symbol: DocumentSymbol | SymbolInformation): string {
  if ("range" in symbol) {
    return formatDocumentSymbol(symbol as DocumentSymbol)
  }
  return formatSymbolInfo(symbol as SymbolInformation)
}
